...
public class IsaiahKelly_Sorting : EditorWindow
{
	...
	[MenuItem("Samelot/IsaiahKelly_Sorting")]
	public static void ShowWindow ()
	{
		// Show existing window instance or make one.
		EditorWindow.GetWindow (typeof(IsaiahKelly_Sorting));
	}
	...
	[MenuItem ("Samelot/IsaiahKelly_Move Up %[")] 
	static void MoveUp ()
	{
	...
	[MenuItem ("Samelot/IsaiahKelly_Move Up %[", true)] 
	...
	[MenuItem ("Samelot/IsaiahKelly_Move Down %]")] 
	...
	// Used to validate the menu item defined by the function above. 
	[MenuItem ("Samelot/IsaiahKelly_Move Down %]", true)] 
	...
	[MenuItem ("Samelot/IsaiahKelly_Sort Children %'")] 
